			...
			<div class="col-sm-4 col-xs-12">
		        <div class="card border-0 bg-transparent">
					<a href="<c:url value="/event/main"/>">
						<img class="card-img-top rounded" src="<c:url value='/img/event/${fn:split(mainEventList[i].eventImg1, \"_\")[1]}'/>" alt="Card image cap">
					</a>
		         	<div class="card-body p-0 pt-5">
			            <div class="meta-post" style="display: flex; justify-content: space-between;">
			              <date class="meta-date">
			              <fmt:parseDate var="startDate" value="${mainEventList[i].eventStart}" pattern="yyyy-MM-dd HH:mm:ss" />
                          <fmt:parseDate var="endDate" value="${mainEventList[i].eventEnd}" pattern="yyyy-MM-dd HH:mm:ss" />
						...
						<h4 class="card-title" style="font-weight: bold;">
							<a href="<c:url value="/event/main"/>">${mainEventList[i].eventTitle }</a>
						</h4>
					</div>
				</div>
			</div>
